...
<div id="wrap">
	...
	<div id="content">
		<span id="title">프로젝트 이력 등록</span>
		<form action="ProjectServlet" method="post">
			<input type="hidden" name="command" value="proj_write">
			<table id="project_input">
				...
				<tr>
					...
					<td class="input">
						<input type="text" id="proj_nm" name="proj_nm" size="50" class="fill_input"/>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td class="input">
						<input type="text" id="client" name="client" size="50" class="fill_input">
						<span></span>
					</td>
				</tr>
				<!-- <tr>
				...
				<tr>
					<td class="info">기간</td>
					<td class="input">
						<input type="date" id="start_dt" name="start_dt" class="fill_input"/>
						&nbsp;~&nbsp;
						<input type="date" id="end_dt" name="end_dt" class="fill_input"/>
				...
				<tr>
					...
					<td class="input">
						<textarea id="proj_content" name="proj_content" rows="10"></textarea>
					</td>
				</tr>
				<tr>
					<td id="btn_area" colspan="2">
						<input type="submit" value="등록" onclick="return projCheck()"/>
						&nbsp;&nbsp;
